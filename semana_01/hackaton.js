...
//ejercicio 09
var listanument=[3 ,6 , 2 , 9, 12 , 7 , 10,5 ];

function versumanumeros()
    {
        var sumapares=0;
        var sumaimpares=0;
        var arrarysuma=[];
        listanument.forEach(element => {
          if(element%2 == 0 )
          {
            sumapares= sumapares + element;
        } 
        else
        {
          sumaimpares= sumaimpares + element;
        }  
      });
      arrarysuma.push(sumapares);
      arrarysuma.push(sumaimpares);
      return arrarysuma;
    }

console.log("Ejercicio 09 suma de números",versumanumeros());
var totalsumas=[];
totalsumas=versumanumeros();
var vtotalpares=totalsumas[0];
var vtotalimpares=totalsumas[1];
console.log("Ejercicio 09 total suma de pares",vtotalpares);
console.log("Ejercicio 09 total suma de impares",vtotalimpares);
